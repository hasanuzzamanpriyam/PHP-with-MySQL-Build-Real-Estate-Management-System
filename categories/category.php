...
if (isset($_GET['name'])) {
    ...
    $singleCategory = $pdo->query("SELECT * FROM properties WHERE home_type='$name'");
    $singleCategory->execute();

    $category_props = $singleCategory->fetchAll(PDO::FETCH_OBJ);
}
?>
...
<div class="site-section site-section-sm bg-light">
    <div class="container">
        ...
        <div class="row mb-5">
            <?php foreach ($category_props as $category_prop) : ?>
                <div class="col-md-6 col-lg-4 mb-4">
                    <div class="property-entry h-100">
                        <a href="<?php echo APPURL; ?>/property-details.php?id=<?php echo $category_prop->id; ?>" class="property-thumbnail">
                            <div class="offer-type-wrap">
                                <span class="offer-type bg-<?php if ($category_prop->types == 'Sale') {
                                                                echo 'danger';
                                                            } else if ($category_prop->types == 'Rent') {
                                                                echo 'success';
                                                            } else if ($category_prop->types == 'Lease') {
                                                                echo 'info';
                                                            } ?>"><?php echo $category_prop->types; ?></span>
                            </div>
                            <img src="<?php echo APPURL; ?>/images/<?php echo $category_prop->image ?>" alt="<?php echo $category_prop->name; ?>" class="img-fluid">
                        </a>
                        <div class="p-4 property-body">
                            <h2 class="property-title"><a href="<?php echo APPURL; ?>/property-details.php?id=<?php echo $category_prop->id; ?>"><?php echo $category_prop->name; ?></a></h2>
                            <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> <?php echo $category_prop->locations; ?></span>
                            <strong class="property-price text-primary mb-3 d-block text-success">$<?php echo number_format($category_prop->price); ?></strong>
                            <ul class="property-specs-wrap mb-3 mb-lg-0">
                                <li>
                                    <span class="property-specs">Beds</span>
                                    <span class="property-specs-number"><?php echo $category_prop->beds; ?></span>

                                </li>
                                <li>
                                    <span class="property-specs">Baths</span>
                                    <span class="property-specs-number"><?php echo $category_prop->baths; ?></span>

                                </li>
                                <li>
                                    <span class="property-specs">SQ FT</span>
                                    <span class="property-specs-number"><?php echo $category_prop->sq_ft; ?></span>
