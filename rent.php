        ...
        <div class="view-options bg-white py-3 px-3 d-md-flex align-items-center">
          ...
          <div class="ml-auto d-flex align-items-center">
            <div>
              ...
              <a href="rent.php?type=rent" class="view-list px-3 border-right active">Rent</a>
...
<div class="site-section site-section-sm bg-light">
  <div class="container">
    ...
    <div class="row mb-5">
      <?php foreach ($rent_props as $rent_prop) : ?>
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            <a href="property-details.php?id=<?php echo $rent_prop->id; ?>" class="property-thumbnail">
              <div class="offer-type-wrap">
                <span class="offer-type bg-<?php if ($rent_prop->types == 'Sale') {
                                              echo 'danger';
                                            } else if ($rent_prop->types == 'Rent') {
                                              echo 'success';
                                            } else if ($rent_prop->types == 'Lease') {
                                              echo 'info';
                                            } ?>"><?php echo $rent_prop->types; ?></span>
              </div>
              <img src="images/<?php echo $rent_prop->image ?>" alt="<?php echo $rent_prop->name; ?>" class="img-fluid">
            </a>
            <div class="p-4 property-body">
              <h2 class="property-title"><a href="property-details.php?id=<?php echo $rent_prop->id; ?>"><?php echo $rent_prop->name; ?></a></h2>
              <span class="property-location d-block mb-3"><span class="property-icon icon-room"></span> <?php echo $rent_prop->locations; ?></span>
              <strong class="property-price text-primary mb-3 d-block text-success">$<?php echo number_format($rent_prop->price); ?></strong>
              <ul class="property-specs-wrap mb-3 mb-lg-0">
                <li>
                  <span class="property-specs">Beds</span>
                  <span class="property-specs-number"><?php echo $rent_prop->beds; ?></span>

                </li>
                <li>
                  <span class="property-specs">Baths</span>
                  <span class="property-specs-number"><?php echo $rent_prop->baths; ?></span>

                </li>
                <li>
                  <span class="property-specs">SQ FT</span>
                  <span class="property-specs-number"><?php echo $rent_prop->sq_ft; ?></span>
