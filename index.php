            ...
            <div class="select-wrap">
              ...
              <select name="types" id="list-types" class="form-control d-block rounded-0">
                <?php foreach ($categories as $category) : ?>
                  <option value="<?php echo APPURL ?>/categories/category.php?name=<?php echo $category->name; ?>">
        ...
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="property-entry h-100">
            <a href="property-details.php?id=<?php echo $prop->id; ?>" class="property-thumbnail">
              ...
              <img src="images/<?php echo $prop->image ?>" alt="<?php echo $prop->name; ?>" class="img-fluid">
            </a>
